...
class Db {
    ...
    private $db = "(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.146.88)(PORT = 1521)))(CONNECT_DATA=(SID=mobile)))"; 
    private $username = "ant";
    private $pwd = "Ceiecant123";
